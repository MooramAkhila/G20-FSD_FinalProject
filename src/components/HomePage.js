...
import mainImage from '../assests/main.png'; // Import the new image
import './homepage.css';

const stats = [
    { label: 'Students Undergoing Training', value: 300, color: '#FFDDC1' },
    { label: 'Students Completed Training', value: 1000, color: '#FFABAB' },
    { label: 'Students Placed', value: 300, color: '#FFC3A0' },
    { label: 'Courses', value: 28, color: '#B9FBC0' },
    { label: 'Ongoing Batches', value: 25, color: '#D0F4DE' },
    { label: 'Trainers', value: 135, color: '#F4A300' }
];
...
const collaborators = [
  { name: 'AstraZeneca', url: 'https://www.astrazeneca.com', color: '#003c71' },
  { name: 'Redapricot', url: 'https://www.redapricot.com', color: '#e36f6f' },
  { name: 'Check.in', url: 'https://www.check.in', color: '#5c4b51' },
  { name: 'Lokibots', url: 'https://www.lokibots.com', color: '#00bfae' },
  { name: 'Onusworks', url: 'https://www.onusworks.com', color: '#0074d9' },
  { name: 'Digital Ocean', url: 'https://www.digitalocean.com', color: '#0080ff' },
  { name: 'TAFE', url: 'https://www.tafe.com', color: '#ff6f61' },
  { name: 'TATA Group of Companies', url: 'https://www.tata.com', color: '#2b2b2b' }
];
...
const HomePage = () => {
  ...
  useEffect(() => {
    ...
    }, 30000); // Switch quotations every 30 seconds
